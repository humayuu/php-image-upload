...
$file = new File();
$stmt = $file->pdo->prepare("SELECT * FROM product_tbl ORDER BY product_name");
$stmt->execute();
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="multiple-images">
                                <?php
                                        $images = explode(',', $product['product_multi_image']);
                                        foreach ($images as $img):

                                        ?>
                                <img src="<?= htmlspecialchars($img) ?>" alt="Image 1" class="thumbnail">
                                <?php endforeach; ?>
                            </div>
                        </td>
                        <td>
